...
per-unit polarity applied, **not** `quality_block_t::active_ref`: a unit whose FE has
dropped lock but has not been switched away yet differs between the two, and that
