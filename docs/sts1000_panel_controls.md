...
| Brightness PWM | `PANEL_LED_PWM` = PE0 (LPTIM2_CH2, AF3) | PE0 → R216 4.7 kΩ → **Q23 BC847W** base (R235 10 kΩ pull-down); Q23 collector → R217 820 Ω → Q22 base (R234 4.7 kΩ off-hold). Non-inverting: PE0 high → Q23 sat → Q22 on. LPTIM PWM driver missing in Zephyr; firmware uses LL glue or 1 kHz software fallback. Hi-Z reset ⇒ double default-OFF |
